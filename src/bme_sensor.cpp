...
bmx280.begin();
  ...
  do
  {
    ...
    bmpdat.temperature = (float)bmx280.getTemperature();
    bmpdat.pressure = (float)bmx280.getPressure();

//    Serial.println(bmpdat.temperature);
//  Serial.println((float) bmx280.getTemperature());
